...
DROP POLICY IF EXISTS "Permitir modificação de roles para super_admin" ON public.roles;
DROP POLICY IF EXISTS "Permitir leitura de admin_users para todos" ON public.admin_users;
DROP POLICY IF EXISTS "Permitir modificação de admin_users para super_admin" ON public.admin_users;
...
-- Permitir acesso público às tabelas (necessário mesmo com RLS)
